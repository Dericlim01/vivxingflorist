    ...
    <div className="flex flex-col min-h-screen pt-32 bg-amber-50">
      ...
      <main className="flex-grow">
        ...
        <div className="relative h-[600px]">
          <Image
            src="/images/products/flower2.jpg"
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-white p-8 bg-black/30">
            ...
            <Link href="/products" className="mt-8 bg-amber-100 text-gray-800 px-8 py-3 rounded-full 
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="group relative overflow-hidden rounded-lg shadow-md bg-white hover:shadow-lg transition-all duration-300 hover:scale-105">
            <div className="relative h-80 w-full">
              <Image
                src="/images/products/customize/mask-flower.jpg"
                alt="Fresh Rose Bouquet"
                fill
          ...
          {/* Card 3 - Preserved*/}
          <div className="group relative overflow-hidden rounded-lg shadow-md bg-white hover:shadow-lg transition-all duration-200 hover:scale-105">
            <div className="relative h-80 w-full">
              <Image
                src="/images/products/preserved/preserved.jpg"
                alt="Mixed Tulips"
                fill
                className="object-cover"
              />
          ...
          <div className="group relative overflow-hidden rounded-lg shadow-md bg-white hover:shadow-lg transition-all duration-300 hover:scale-105">
            <div className="relative h-80 w-full">
              <Image
                src="/images/products/preserved/preserved1.jpg"
                alt="Orchid Elegance"
                fill
                className="object-cover"
              />
